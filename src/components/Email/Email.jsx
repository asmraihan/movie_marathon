...
const Email = () => {
  ...
  const sendEmail = (e) => {  
    ...
    emailjs.sendForm('service_6mct2ae', 'template_sjj343r', form.current, 'd6RMeQuoZkOZfaBkc')
      .then((result) => {
    ...
    return (
      <div className="w-2/6 mx-auto">
        ...
        <form ref={form} onSubmit={sendEmail} action="#" className="mb-6">

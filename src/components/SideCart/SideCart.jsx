...
const SideCart = ({time}) => {
    ...
    return (
        <div className='p-5 text-center bg-green-100 h-full'>
            ...
            <p className='border-2 rounded-md my-2 bg-red-300 p-2'>{updatedTime} min</p>
            ...
            <p className='border-2 rounded-md my-2 bg-red-300 p-2'>{breakTime} min</p>
            <button onClick={()=>toast(`${updatedTime - breakTime} min`)}
        href="#"
